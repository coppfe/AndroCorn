...
from ..content.context import ContextImpl
...
class AccessibilityInteractionController(metaclass=JavaClassDef, jvm_name='android/view/AccessibilityInteractionController'):
    ...
    @java_method_def(
        name='performAccessibilityActionUiThread',
        args_list=["jobject"],
        signature='(Landroid/os/Message;)V',
        native=False
    )
    def performAccessibilityActionUiThread(self, emu, msg):
        pass
...
class ActivityThread(metaclass=JavaClassDef, jvm_name='android/app/ActivityThread', 
    ...
    def currentApplication(emu: 'Emulator'):
