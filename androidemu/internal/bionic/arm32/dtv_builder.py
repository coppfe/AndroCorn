...
from unicorn.unicorn_py3.unicorn import MemRegionStruct
...
if TYPE_CHECKING:
    ...
    from .tls_bootstrap import BionicTLS_ARM32
...
class DTVBuilderARM32(DTVBuilder):
    ...
    def __init__(self, memory: 'MemoryMap', mu: 'Uc', tls: 'BionicTLS_ARM32') -> None:
