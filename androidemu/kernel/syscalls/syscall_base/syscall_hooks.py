...
class SyscallHooks:
    ...
    def __init__(self, emu: 'Emulator', syscall_handler: 'SyscallHandlers'):
        ...
        if (self.__emu.arch == emu_const.ARCH_ARM32):
            ...
            self._syscall_handler.set_handler(0xBF,     "getrlimit",        2, self._system_syscalls._getrlimit)
            ...
            self._syscall_handler.set_handler(0xF8,     "exit_group",       1, self._process_syscalls._exit)
            ...
            self._syscall_handler.set_handler(0x5E,     "exit_group",       1, self._process_syscalls._exit)
            ...
            self._syscall_handler.set_handler(0xA3,     "getrlimit",        2, self._system_syscalls._getrlimit)
