...
class IoctlHandler:
    def __init__(self, mu):
        ...
        tiocgpin = success("TIOCGPIN")
        tiocgptpeer = success("TIOCGPTPEER")
        ...
        self._handlers = {
            ...
            IOCTL_TIOCGPTN:             tiocgpin,
            IOCTL_TIOCGPTPEER:          tiocgptpeer,
            IOCTL_TIOCGSERIAL:          self._handle_tiocgserial,
        }

    # def _handle_tiocgpin(self, pty, *args):
    #     return 0
    
    # def _handle_tiocgptpeer(self, pty, *args):
    #     return 0
    
    def _handle_tiocgserial(self, *args):
        return -EINVAL # ?
