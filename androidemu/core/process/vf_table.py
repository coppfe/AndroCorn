...
if TYPE_CHECKING:
    ...
    from androidemu.kernel.dev.content import ContentGenerator
...
class VirtualFileTable:
    ...
    """
    def __init__(self, mu: 'Uc', ctx: 'GlobalContextMachine'):
        ...
        main_pid = self._ctx.pid
        self._tid_to_fds[main_pid] = {}

        self._init_std_fds()

    def attach_generator(self, content_generator: 'ContentGenerator'):
    ...
    def create_virtual_file(self, name: str, name_in_system: str, fd: int, is_virtual: bool = False) -> VirtualFile:
        vf = VirtualFile(self._mu, name, fd, name_in_system=name_in_system, is_virtual=is_virtual, content_generator=self._content_generator)
        return vf
